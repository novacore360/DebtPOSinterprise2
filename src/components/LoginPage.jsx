...
export default function LoginPage() {
  ...
  return (
    <div style={{
      minHeight: '100vh',
      background: 'linear-gradient(135deg, var(--page-bg-alt) 0%, var(--nav-bg) 50%, var(--login-bg-3) 100%)',
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: 36 }}>
            ...
            <h1 style={{
              ...
              background: 'linear-gradient(135deg, var(--brand-text-1), var(--brand-text-2))',
              WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent',
              backgroundClip: 'text', letterSpacing: 0.5,
            }}>Marnie Store</h1>
            <p style={{ color: 'var(--wa-5)', margin: '8px 0 0', fontSize: 13, letterSpacing: 2, textTransform: 'uppercase' }}>
          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={{ marginBottom: 20 }}>
              <div style={{ position: 'relative' }}>
                ...
                <input
                  ...
                  onBlur={e => { e.target.style.borderColor = 'var(--wa-1)'; e.target.style.boxShadow = 'none'; }}
                />
              </div>
            </div>
            ...
            <button
              ...
              style={{
                ...
                border: 'none', borderRadius: 12, color: 'var(--text-primary)',
        ...
        <p style={{ color: 'var(--wa-25)', textAlign: 'center', marginTop: 16, fontSize: 12, letterSpacing: 1 }}>
      ...
      <style>{`
        ...
        input:-webkit-autofill { -webkit-box-shadow: 0 0 0 30px var(--nav-bg-t) inset !important; -webkit-text-fill-color: var(--text-primary) !important; }
      `}</style>
    </div>
  );
}
