          ...
          <div style={{ background:'#1a1a2e', borderRadius:16, padding:22, maxWidth:420, width:'100%', border:'1px solid rgba(255,255,255,0.1)', maxHeight:'90vh', overflowY:'auto' }}>
            ...
            {bluetoothSupported ? (
              <button onClick={printBluetoothReceipt} disabled={printing} style={{
                ...
                borderRadius:9, color: printerStatus === 'connected' ? '#1cc88a' : '#fff', fontWeight:700, cursor: printing ? 'not-allowed' : 'pointer', fontSize:14,
            ...
            <div style={{ display:'flex', gap:8 }}>
              <button onClick={printReceipt} style={{ flex:1, padding:11, background:'rgba(255,255,255,0.08)', border:'none', borderRadius:9, color:'#fff', fontWeight:600, cursor:'pointer', fontSize:13, display:'flex', alignItems:'center', justifyContent:'center', gap:6 }}>
