  ...
  return (
    ...
    >
      <div>
        ...
        {subtext && (
          <div style={{ color: 'var(--wa-4)', fontSize: 12, marginTop: 4 }}>
            {subtext}
          </div>
        )}
        {trend && (
...
function RecentTransactionRow({ transaction, customer }) {
  ...
  return (
    <tr style={{ borderBottom: '1px solid var(--wa-04)', transition: 'background 0.15s' }}
      ...
      <td style={{ padding: '10px 8px', color: 'var(--wa-5)', fontSize: 12 }}>
    ...
    <div style={{
      ...
      <div style={{ flex: 1 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
          ...
          <div style={{ color: 'var(--text-primary)', fontSize: 13, fontWeight: 600 }}>{product.name}</div>
        </div>
        <div style={{ color: 'var(--wa-4)', fontSize: 11, marginLeft: 32 }}>
  ...
  return (
    <div style={{ maxWidth: '100%', overflowX: 'hidden' }}>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ color: 'var(--wa-5)', marginTop: 4, fontSize: 13 }}>
      ...
      <div style={{ 
        ...
        {secondaryStats.map((stat, idx) => (
          <div key={idx} style={{
            ...
            <div>
              <div style={{ color: 'var(--wa-5)', fontSize: 12 }}>{stat.label}</div>
              <div style={{ color: 'var(--text-primary)', fontSize: 24, fontWeight: 700 }}>{stat.value}</div>
            </div>
            <div style={{
      ...
      <div style={{ 
        ...
        <div style={S.card}>
          <div style={{ 
            ...
            <span style={{ color: 'var(--wa-4)', fontSize: 11 }}>
          ...
          {stats.recentTransactions.length === 0 ? (
            ...
            <div style={{ overflowX: 'auto' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13, minWidth: 500 }}>
                <thead>
                  <tr>
                    <th style={{ color: 'var(--wa-4)', fontWeight: 600, textAlign: 'left', padding: '8px 8px', borderBottom: '1px solid var(--wa-07)' }}>Customer</th>
                    <th style={{ color: 'var(--wa-4)', fontWeight: 600, textAlign: 'right', padding: '8px 8px', borderBottom: '1px solid var(--wa-07)' }}>Amount</th>
                    <th style={{ color: 'var(--wa-4)', fontWeight: 600, textAlign: 'left', padding: '8px 8px', borderBottom: '1px solid var(--wa-07)' }}>Date</th>
                    <th style={{ color: 'var(--wa-4)', fontWeight: 600, textAlign: 'center', padding: '8px 8px', borderBottom: '1px solid var(--wa-07)' }}>Status</th>
                  </tr>
                </thead>
                <tbody>
          ...
          {stats.recentTransactions.length > 0 && (
            <div style={{ 
              marginTop: 16, 
              paddingTop: 12, 
              borderTop: '1px solid var(--wa-07)',
              textAlign: 'center',
            }}>
              <span style={{ color: 'var(--wa-3)', fontSize: 11 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          {/* Quick Stats Summary */}
          <div style={S.card}>
            <h6 style={{ color: 'var(--text-primary)', fontWeight: 700, marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              <div>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
                  <span style={{ color: 'var(--wa-5)', fontSize: 12 }}>Profit Margin</span>
              ...
              <div style={{ 
                ...
                <div>
                  <div style={{ color: 'var(--wa-4)', fontSize: 11 }}>Total Orders</div>
                  <div style={{ color: 'var(--text-primary)', fontSize: 20, fontWeight: 700 }}>{stats.totalOrders}</div>
                </div>
                <div>
                  <div style={{ color: 'var(--wa-4)', fontSize: 11 }}>Items Sold</div>
                  <div style={{ color: 'var(--text-primary)', fontSize: 20, fontWeight: 700 }}>{stats.totalItemsSold}</div>
                </div>
                <div>
                  <div style={{ color: 'var(--wa-4)', fontSize: 11 }}>Paid Orders</div>
                  <div style={{ color: '#1cc88a', fontSize: 20, fontWeight: 700 }}>{stats.paidCount}</div>
                </div>
                <div>
                  <div style={{ color: 'var(--wa-4)', fontSize: 11 }}>Pending</div>
